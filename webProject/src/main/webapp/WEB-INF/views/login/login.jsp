...
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko-kr" xml:lang="ko-kr" class="ko-kr bnet-next" >
...
<link rel="stylesheet" type="text/css" media="all" href="./resources/css/login/global.css" />
<link rel="stylesheet" type="text/css" media="all" href="./resources/css/login/nav-client.css" />
<link rel="stylesheet" type="text/css" media="all" href="./resources/css/login/logo_pic.css" />
<script src="https://kit.fontawesome.com/2c3a00978e.js" crossorigin="anonymous"></script>
<link rel="stylesheet" type="text/css" media="(max-width:800px)" href="./resources/css/login/nav-client-responsive.css" />
<meta name="viewport" content="width=device-width" />
<meta property="og:image" content="/login/static/images/meta/opengraph.png?v=58-1" />
<meta property="og:image:type" content="image/png" />
<meta property="og:image:width" content="1200" />
<meta property="og:image:height" content="630" />
<meta property="og:image:alt" content="배경이 있는 Battle.net 로고" />
</head>
<body class = "kr ko-kr login-template blz web bnet-next tk-bnet-next ce-standalone-browser "
data-embedded-state = "STATE_LOGIN"
data-baseUrl = "/login/ko"
...
<p class="info-body"></p>
<button class="btn btn-block hide visible-phone" id="info-phone-close">닫기</button>
</div>
...
<input type="hidden" name="ref" value="https://play.blizzard.kr/ko/overwatch2/snowshop5-invasion" />
<input type="hidden" name="app" value="blz" />
<input type="hidden" name="scheme" value="" />
<input type="hidden" name="deviceProof" value="" />
<input type="hidden" id="csrftoken-googleLogin" class="csrftoken" name="csrftoken" value="bd8cde73-7c96-4cc4-be2d-1ca2e4f4d328" />
</form>
...
<input type="hidden" name="scheme" value="" />
<input type="hidden" name="deviceProof" value="" />
<input type="hidden" id="csrftoken-facebookLogin" class="csrftoken" name="csrftoken" value="bd8cde73-7c96-4cc4-be2d-1ca2e4f4d328" />
</form>
...
<input type="hidden" name="scheme" value="" />
<input type="hidden" name="deviceProof" value="" />
<input type="hidden" id="csrftoken-appleLogin" class="csrftoken" name="csrftoken" value="bd8cde73-7c96-4cc4-be2d-1ca2e4f4d328" />
</form>
</div>
<div class="useResponse social-login external-login-container">
<form method="post" action="/login/signin/live" id="liveLogin" class="class org.apache.maven.project.MavenProject" enctype=""
>
<button
id="live"
role="row"
...
rel="external"
aria-label="Xbox Network 계정으로 로그인"
title="Xbox Network 계정으로 로그인"
tabindex="0"
>
<i class="icon-live"></i>
</button>
<input type="hidden" name="scope" value="Xboxlive.signin" />
<input type="hidden" name="ref" value="https://play.blizzard.kr/ko/overwatch2/snowshop5-invasion" />
<input type="hidden" name="app" value="blz" />
<input type="hidden" name="scheme" value="" />
<input type="hidden" name="deviceProof" value="" />
<input type="hidden" id="csrftoken-liveLogin" class="csrftoken" name="csrftoken" value="bd8cde73-7c96-4cc4-be2d-1ca2e4f4d328" />
</form>
<form method="post" action="/login/signin/psn" id="psnLogin" class="class org.apache.maven.project.MavenProject" enctype=""
>
<button
id="psn"
role="row"
...
rel="external"
aria-label="PlayStation™Network 계정으로 로그인"
title="PlayStation™Network 계정으로 로그인"
tabindex="0"
>
<i class="icon-psn"></i>
</button>
...
<input type="hidden" name="scheme" value="" />
<input type="hidden" name="deviceProof" value="" />
<input type="hidden" id="csrftoken-psnLogin" class="csrftoken" name="csrftoken" value="bd8cde73-7c96-4cc4-be2d-1ca2e4f4d328" />
</form>
<form method="post" action="/login/signin/nintendo" id="nintendoLogin" class="class org.apache.maven.project.MavenProject" enctype=""
>
<button
id="nintendo"
role="row"
...
rel="external"
aria-label="Nintendo 계정으로 로그인"
title="Nintendo 계정으로 로그인"
tabindex="0"
>
...
<input type="hidden" name="scheme" value="" />
<input type="hidden" name="deviceProof" value="" />
<input type="hidden" id="csrftoken-nintendoLogin" class="csrftoken" name="csrftoken" value="bd8cde73-7c96-4cc4-be2d-1ca2e4f4d328" />
</form>
<form method="post" action="/login/signin/steam" id="steamLogin" class="class org.apache.maven.project.MavenProject" enctype=""
>
<button
id="steam"
role="row"
...
<input type="hidden" name="scheme" value="" />
<input type="hidden" name="deviceProof" value="" />
<input type="hidden" id="csrftoken-steamLogin" class="csrftoken" name="csrftoken" value="bd8cde73-7c96-4cc4-be2d-1ca2e4f4d328" />
</form>
</div>
...
>
<p id="cookie-check" class="hide">브라우저의 쿠키가 차단되어있습니다. 계속하려면 쿠키를 허용하여 주십시오.</p>
</div>
<noscript>
...
<input
id="password"
aria-label="비밀번호 영역, 비밀번호를 입력하세요"
name="password"
title="비밀번호"
maxlength="128"
type="password"
...
autocorrect="off"
spellcheck="false"
data-password-show-aria="비밀번호 표시" data-password-hide-aria="비밀번호 숨기기"
/>
<span class="input-after"></span>
...
<input type="hidden" id="csrftoken" class="csrftoken" name="csrftoken" value="bd8cde73-7c96-4cc4-be2d-1ca2e4f4d328" />
<input type="hidden" id="sessionTimeout" name="sessionTimeout" value="1693055987404"/>
<input type="hidden" name="deviceProof" value="" />
</form>
...
<a class="nav-item nav-a" href="https://www.blizzard.com/company/legal/eula" data-analytics="global-nav" data-analytics-placement="Footer - eula">Blizzard 최종 사용자 라이선스 계약</a>
<span>|</span>
<a class="nav-item nav-a footer-links-snowflake" href="https://www.blizzard.com/company/about/privacy.html" data-analytics="global-nav" data-analytics-placement="Footer - Privacy">개인정보 처리방침</a>
<span>|</span>
<a class="nav-item nav-a" href="https://www.blizzard.com/company/legal/" data-analytics="global-nav" data-analytics-placement="Footer - Terms">이용 약관</a>
<span>|</span>
<a class="nav-item nav-a" href="https://kr.blizzard.com/company/about/infringementnotice.html" data-analytics="global-nav" data-analytics-placement="Footer - copyright">저작권 고지</a>
<span>|</span>
<a class="nav-item nav-a" href="/login/cookies" data-analytics="global-nav" data-analytics-placement="Footer - Cookies">쿠키</a>
<span>|</span>
<a class="nav-item nav-a" href="/login/cookies#settings" data-analytics="global-nav" data-analytics-placement="Footer - Cookie Settings">쿠키 설정</a>
<div class="copyright">©2023 Blizzard Entertainment, Inc. 모든 권리는 Blizzard Entertainment에 있습니다.</div>
...
블리자드 엔터테인먼트 유한 회사<br />주소: 06164 서울시 강남구 테헤란로 521 파르나스타워 15층<br />대표 번호: 1644-0727 | 팩스 번호: (02)544-3038 | 이메일: <a href="https://kr.battle.net/support/ko/">websupport@blizzard.co.kr</a><br />사업자 등록 번호: 211-87-49910 | 통신 판매업 신고 번호: 강남-6017호 | <a href="http://www.ftc.go.kr/bizCommPop.do?wrkr_no=2118749910">사업자정보확인</a><br />대표이사: 다니엘 알레그레 | 개인정보 보호책임자: 이강호
</div>
</div>
